...
const TradingSchedule = ({ isEdit, dataProductCcq, edit, fundForm }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className={styles.trading_schedule_l}>Thời hạn đặt mua: </p>
        {isEdit || query.id === "create" ? (
          <div>
            <InputComponent
              value={fundForm?.time_closed}
              placeholder={"00:00"}
              onChange={(e) =>
                edit({ ...fundForm, time_closed: e.target.value })
              }
            />
          </div>
        ) : (
          <p className={styles.text_trading_schedule}>
            {dataProductCcq?.time_closed}
          </p>
        )}
      </div>
      <div>
        ...
        {isEdit || query.id === "create" ? (
          <div>
            <InputComponent
              ...
              placeholder={"00:00"}
              onChange={(e) =>
                edit({ ...fundForm, order_closing_time: e.target.value })
              }
            />
          </div>
        ) : (
        ...
        {isEdit || query.id === "create" ? (
          <div>
            <InputComponent
              ...
              placeholder={"00:00"}
              onChange={(e) =>
                edit({ ...fundForm, time_available: e.target.value })
              }
            />
          </div>
        ) : (
        ...
        {isEdit || query.id === "create" ? (
          <div>
            <InputSelectDayCCQ
              ...
              onChange={(e) =>
                edit({ ...fundForm, order_matching_date: e.target.value })
              }
            />
          </div>
        ) : (
          <p className={styles.text_trading_schedule}>
            {dataProductCcq?.order_matching_date || 1} ngày làm việc sau ngày
            đóng sổ lệnh
          </p>
        )}
      </div>
      <div>
        ...
        {isEdit || query.id === "create" ? (
          <InputSelectDayCCQ
            ...
            onChange={(e) =>
              edit({ ...fundForm, date_receiving_ccq: e.target.value })
            }
          />
        ) : (
          <p className={styles.text_trading_schedule}>
            {dataProductCcq?.date_receiving_ccq || 1} ngày làm việc sau ngày
            đóng sổ lệnh
          </p>
        )}
      </div>
        ...
        {isEdit || query.id === "create" ? (
          <div>
            <InputSelectDayCCQ
              ...
              onChange={(e) =>
                edit({ ...fundForm, payment_received_date: e.target.value })
              }
            />
          </div>
        ) : (
          <p className={styles.text_trading_schedule}>
            {dataProductCcq?.payment_received_date || 1} ngày làm việc sau ngày
            đóng sổ lệnh
          </p>
        )}
      </div>
