  ...
  const handleRequest = async (verificationConfirm) => {
    ...
    if (verificationConfirm === "update") {
      const res = await axiosInstance.put(
        `/admin/edit-product-ccq/${query.id}`,
        newForm
      );
  ...
  return (
    <div className={`${styles["account-info"]}`}>
        ...
        <Row style={{ width: "100%" }} gutter={[20, 0]}>
          <Col xl={12}>
            <div className="flex" style={{ alignItems: "center" }}>
              ...
              <p className={`${styles["value"]} flex-1`}>
                {Number(dataProductCcq?.current_price)?.toLocaleString("en-US")}
              </p>
            </div>
          </Col>
          <Col xl={12}>
            <div className="flex" style={{ alignItems: "center" }}>
              ...
              {isEdit || query.id === "create" ? (
                ...
                <p className={`${styles["value"]} flex-1`}>
                  {status?.[dataProductCcq?.status - 1]}
                </p>
              )}
            </div>
          </Col>
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  placeholder={"N/A"}
                  onChange={(e) =>
                    edit({ ...fundForm, name_fund: e.target.value })
                  }
                />
              ) : (
                <p className={`${styles["value"]} flex-1`}>
                  {dataProductCcq?.name_fund}
                </p>
              )}
            </div>
          </Col>
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  placeholder={"N/A"}
                  onChange={(e) =>
                    edit({ ...fundForm, company: e.target.value })
                  }
                />
              ) : (
                <p className={`${styles["value"]} flex-1`}>
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  placeholder={"N/A"}
                  onChange={(e) =>
                    edit({ ...fundForm, bank_name: e.target.value })
                  }
                />
              ) : (
                <p className={`${styles["value"]} flex-1`}>
        ...
        <Row style={{ width: "100%" }} gutter={[20, 0]}>
          <Col xl={12}>
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <AreaComponent
                  value={fundForm?.represent}
                  onChange={(e) =>
                    edit({ ...fundForm, represent: e.target.value })
                  }
                  placeholder={"N/A"}
                />
              ) : (
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <AreaComponent
                  ...
                  placeholder={"N/A"}
                  onChange={(e) =>
                    edit({ ...fundForm, proportion: e.target.value })
                  }
                />
              ) : (
                <div
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  placeholder={"N/A"}
                  onChange={(e) =>
                    edit({ ...fundForm, audit_firm: e.target.value })
                  }
                />
              ) : (
                <p className={`${styles["value"]} flex-1`}>
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  placeholder={"N/A"}
                  onChange={(e) =>
                    edit({ ...fundForm, fund_converted: e.target.value })
                  }
                />
              ) : (
                <p className={`${styles["value"]} flex-1`}>
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  type="number"
                  onChange={(e) =>
                    edit({ ...fundForm, min_transaction: e.target.value })
                  }
                />
              ) : (
                <p className={`${styles["value"]} flex-1`}>
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  placeholder={"0"}
                  onChange={(e) =>
                    edit({ ...fundForm, min_amout_sell: e.target.value })
                  }
                />
              ) : (
                <p className={`${styles["value"]} flex-1`}>
          ...
          <Col xl={12}>
            <div className="flex">
              <p className={`${styles["label"]}`}>
                Số CCQ tối thiểu còn lại sau lệnh bán:
              </p>
              {isEdit || query.id === "create" ? (
                <InputComponent
                  ...
                  placeholder={"0"}
                  onChange={(e) =>
                    edit({ ...fundForm, min_amout_after_sell: e.target.value })
                  }
                />
              ) : (
                <p
            ...
            <div className="flex">
              ...
              {isEdit || query.id === "create" ? (
                <AreaComponent
                  ...
                  placeholder={"N/A"}
                  onChange={(e) =>
                    edit({ ...fundForm, purchase_account: e.target.value })
                  }
                />
              ) : (
                <div
                ...
                >
                  {dataProductCcq?.purchase_account
                    ?.split(",")
                    ?.map((item, index) => (
                      <p key={index}>{item}</p>
                    ))}
      ...
      {query.id === "create" && (
        <div className={`${styles["confirm-box"]}`}>
          <div>
            <p className={`${styles["text-note"]}`}>Nhập ‘create’ để tạo mới</p>
            <Input
              styleWr={{ width: "136px", marginTop: "16px" }}
              placeholder="create"
              value={confirm}
