...
function RequestUpdateDetail() {
    ...
    <div className='main-content'>
        ...
        <div className={`${styles['box']}`}>
                ...
                <Row style={{width: '100%'}} gutter={[0, 20]}>
                    {data?.request?.request_status_id ===0 && (
                        <Col xl={12}>
                            <Row gutter={[0,20]}>
                                <Col xl={24}>
                                    <p className='text-orange'>Thông tin thay đổi</p>
                                </Col>
                                <Col xl={24}>
                                    <div className='flex'>
                                        <p className={`${styles['label']}`}>Tài khoản:</p>
                                        <p className={`${styles['value']}`}>{data?.old_user?.email}</p>
                                    </div>
                                </Col>
                                <Col xl={24}>
                                    <div className='flex'>
                                        <p className={`${styles['label']}`}>Vai trò:</p>
                                        <p className={`${styles['value']}`}>{data?.old_user?.role?.name}</p>
                                    </div>
                                </Col>
                                <Col xl={24}>
                                    <div className='flex'>
                                ...
                                <Col xl={24}>
                                    <div className='flex'>
                                        ...
                                        <p className={`${styles['value']}`}>{data?.old_user?.name}</p>
                                    </div>
                                </Col>
                                <Col xl={24}>
                                    <div className='flex'>
                                        <p className={`${styles['label']}`}>Điện thoại:</p>
                                        <p className={`${styles['value']}`}>{data?.old_user?.phone}</p>
                                    </div>
                                </Col>
                                <Col xl={24}>
                                    <div className='flex'>
                                        <p className={`${styles['label']}`}>Trạng thái:</p>
                                        <p className={`${styles['value']}`}>{data?.old_user?.admin_user_status?.name}</p>
                                    </div>
                                </Col>
                            </Row>
                        </Col>
                    ...
                    <Row gutter={[0,20]}>
                            <Col xl={24}>
                                <p className='text-orange'>Thông tin hiện tại</p>
                            </Col>
                            <Col xl={24}>
                                <div className='flex'>
                                    <p className={`${styles['label']}`}>Tài khoản:</p>
                                    <p className={`${styles['value']}`}>{data?.request?.admin_request_data?.email}</p>
                                </div>
                            </Col>
                            <Col xl={24}>
                                <div className='flex'>
                                    <p className={`${styles['label']}`}>Vai trò:</p>
                                    <p className={`${styles['value']}`}>{data?.request?.admin_request_data?.role?.name}</p>
                                </div>
                            </Col>
                            <Col xl={24}>
                                <div className='flex'>
                            ...
                            <Col xl={24}>
                                <div className='flex'>
                                    <p className={`${styles['label']}`}>Tên:</p>
                                    <p className={`${styles['value']}`}>{data?.request?.admin_request_data?.name}</p>
                                </div>
                            </Col>
                            <Col xl={24}>
                                <div className='flex'>
                                    <p className={`${styles['label']}`}>Điện thoại:</p>
                                    <p className={`${styles['value']}`}>{data?.request?.admin_request_data?.phone}</p>
                                </div>
                            </Col>
                            <Col xl={24}>
                                <div className='flex'>
                                    <p className={`${styles['label']}`}>Trạng thái:</p>
                                    <p className={`${styles['value']}`}>{data?.request?.admin_request_data?.admin_user_status?.name}</p>
                                </div>
                            </Col>
                        </Row>
                    </Col>
            ...
            {!isConfirm && data?.request?.request_status_id == 0  &&(
                <>
                ...
                <div className='flex center'>
                    <Button
                        title={loading && confirm === 'reject' ? <LoadingOutlined /> : "Từ chối"}
                    ...
                    />
                    <Button
                        title={loading && confirm === 'approve' ? <LoadingOutlined/> : "Phê duyệt"} 
                        onClick={handleRequest} 
...
export default RequestUpdateDetail